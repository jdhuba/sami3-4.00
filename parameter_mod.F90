...
!      total number of workers
    ...
    integer,parameter ::  numwork = 24

!      number of altitudes (e.g., field lines)

    integer,parameter :: nf   = 80
...
!      nseg needs to be even
    ...
    integer,parameter :: nz0 = 204, nextra = 0, nseg = 2, &
...
!      grid for madala potential solver
    ...
    integer,parameter ::  nnx =  nlt + 1, nny = nf - 1, nnyw = nf + 2
    integer,parameter ::  nyextra = 5, nnyt = nny + nyextra, nnytw = nnyw + nyextra
...
!      variables to keep down the error messages
    ...
    real,parameter :: emass  = 9.1094e-24    
